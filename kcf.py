import cv2
import numpy as np
#fft2,ifft2:快速傅里叶变换与反变换
#fftshift:作用：交换行向量的左右两半部分。在FFT里的作用：通过将零频分量移动到数组中心。
...
class Tracker():
    ...
    def get_feature(self, image, roi):
        ...
        #padding 后的图像从原图中截取出来
        sub_image = image[y:y+h, x:x+w, :]
        #弄成最开始设定的HOG的框，方便进行特征提取
    ...
    def init(self, image, roi):
        """
        initiate super param like pw & ph by first frame
        :param image:
        :param roi:
        :return: no return
        """
